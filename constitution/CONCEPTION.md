...
4. **Session cap**: `--max-autopilot-continues 5` limits how many continuation steps you take per session.
...
Runs at 9:00 UTC daily or on manual dispatch:
...
4. **Your `schema_version` is 1**. If you need to change the data structure (add fields, restructure), bump this version and update your tests accordingly.
